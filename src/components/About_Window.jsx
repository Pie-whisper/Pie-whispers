      ...
      <div style={{ display: "flex", alignItems: "center", flexWrap: "wrap" }}>
        ...
        >
          ...
          <p style={{ marginTop: "10px" }}>
            ...
            <strong style={{ color: "purple" }}>Myself</strong> &{" "}
            <strong style={{ color: "orange" }}>My future</strong>
          </p>
        </div>
      </div>
...
>
   <p style={{ margin: 0 }}>
  Yo, I’m Pie. <br /><br />
  I’m 16, not just dreaming — I’m doing. I build what I see in my head — sometimes it’s code, sometimes it’s videos, sometimes it’s a full damn vibe. <br /><br />
