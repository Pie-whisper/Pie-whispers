...
const getWallpaperColor = (index) => {
  ...
  return colors[index] || "rgba(255, 255, 254, 0.1)";
};
...
const SvgIcon = () => {
  ...
  fontSize: "1.4vw",
  fontWeight: "400",
  fontFamily: "'Anime Ace', 'Comic Sans MS', cursive", // Anime-style fallback
  color: "#ffffffff", // Sweet pink
  zIndex: 10,
  textShadow: "0 0 0.1vw #b700ffff", // soft glow for extra pop!
};
  ...
  return (
    <div style={{ width: "100vw", height: "100vh", overflow: "hidden", position: "relative", background: "black" }}>
      ...
      {[
       ...
       { id: "about", x: 39, y: 50, anim: aboutmeAnimation, text: "About Pie", setOpen: setAboutWindowOpen },
       { id: "links", x: 46, y: 50, anim: linksAnimation, text: "-- Links", setOpen: setLinkWindowOpen },
       { id: "contact", x: 54, y: 50, anim: contactAnimation, text: "Contact", setOpen: setContactWindowOpen },
       { id: "faq", x: 61, y: 50, anim: faqAnimation, text: " - FAQ", setOpen: setFaqWindowOpen },
  ...
  <h1 style={{
    fontSize: "2vw",
    fontWeight: "600",
    fontFamily: "'Anime Ace', 'Comic Sans MS', cursive",
    color: "#ffb3f3",
    textShadow: "0 0 1vw #ff40c0, 0 0 2vw #ff40c0",
    letterSpacing: "0.1vw",
  }}>
    PIE WHISPERS
  </h1>
  <p style={{
    ...
    I'm 16 years old but still Don't know what to code 😸✨
      ...
      <Player autoplay loop src={flyingGirlAnimation} style={{
        position: "absolute", left: "40vw", top: "-10vh", width: "12.7vw", height: "78vh",
